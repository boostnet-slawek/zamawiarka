...
<body>
  <div id="main">
    ...
    <a href="index.php"><img src="img/wstecz.png"></a>&nbsp;<img src="img/dodaj.png" id="create-user">&nbsp;<a href="tabela_all.php"><img src="img/wszystkie.png"></a>&nbsp;<a href="tabelka_end.php"><img src="img/zakonczone.png"></a>&nbsp;<a href="raporty.php"><img src="img/raporty.png"></a><br>
    <div id="demo">
  ...
  <div id="dialog-form" title="Dodaj zamówienie">
    ...
    <form>
      <fieldset>
        ...
        <input type="przyjechalo" name="przyjechalo" id="przyjechalo" value="tak/nie" class="text ui-widget-content ui-corner-all">
        <label for="fv_zakup_typ">Zakup</label>
        <input type="fv_zakup_typ" name="fv_zakup_typ" id="fv_zakup_typ" value="mail/papier" class="text ui-widget-content ui-corner-all">
